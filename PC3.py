...
#with st.sidebar:
    #selected = option_menu(None,['Inicio', 'Experiencia', 'Gráficos'] , 
        #icons=['lamp','lamp', 'lamp'], menu_icon="filetype-py", default_index=0)
...
if selected == 'Inicio':
    ...
    col1.image("fotoño.jpg", caption='Adrian', width=300)
